...
with open("C:\Documents\BlueSky\scenario\experimental" +"\\" + "Trajectories.scn", "w") as fin:
    fin.write('\n'.join(banana))
os.startfile("C:\Documents\BlueSky\scenario\experimental" +"\\" + "Trajectories.scn")
